...
def process_output_one(df_emp_exp_and_calls:DataFrame, 
                     df_emp_per_and_sales: DataFrame,
                     df_output_path) -> None:
    ...
    df_final = df_emp_exp_and_calls \
                    .join(df_emp_per_and_sales, \
                          (df_emp_exp_and_calls["area"]=="IT") & (df_emp_exp_and_calls["id"]==df_emp_per_and_sales["emp_id"]),
                         "inner") \
                    .drop("emp_id") \
